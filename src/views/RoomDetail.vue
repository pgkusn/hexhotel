        ...
        <div v-if="room" class="pt-10 px-20">
            <div class="relative">
                <div class="hero bg-cover bg-center" :style="{ 'background-image': `url(${currentImageUrl})` }">
                    <h1 class="text-dark-blue bg-white text-4xl font-bold italic pb-2">
                        {{ room.name }}
                    </h1>
                    <p class="text-white bg-dark-gray absolute top-0 left-full uppercase py-2">
                        weekday price
                    </p>
                </div>
                ...
                <div ref="reserveAreaEl" class="reserve-area-container top-32" :class="[isFixed ? 'fixed' : 'absolute', { 'is-fixed-bottom': isFixedBottom }]">
                    <p class="text-dark-blue text-right">
                        <strong class="text-2xl">${{ format(room.normalDayPrice) }} NTD</strong> / night
                    </p>
                    <p class="text-sm text-dark-gray text-right mb-6">
            ...
            <section class="mt-12 w-1/2">
                <h1 class="mb-6 text-xl font-bold text-dark-blue">
                    Description
                </h1>
            ...
            <section class="mt-12 w-1/2">
                ...
                <ul class="grid grid-cols-3 gap-6">
                    <li class="flex items-center" :class="room.amenities['Wi-Fi'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">wifi</span>
                        <span>Wi-Fi</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Television'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">personal_video</span>
                        <span>Television</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Great-View'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">landscape</span>
                        <span>Great View</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Breakfast'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">restaurant</span>
                        <span>Breakfast</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Air-Conditioner'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">ac_unit</span>
                        <span>Air Conditioner</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Smoke-Free'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">smoke_free</span>
                        <span>Smoke Free</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Mini-Bar'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">local_bar</span>
                        <span>Mini Bar</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Refrigerator'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">kitchen</span>
                        <span>Refrigerator</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Child-Friendly'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">child_care</span>
                        <span>Child-Friendly</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Room-Service'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">room_service</span>
                        <span>Room Service</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Sofa'] ? 'text-dark-gray' : 'text-light-gray'">
                        <span class="material-icons mr-4">weekend</span>
                        <span>Sofa</span>
                    </li>
                    <li class="flex items-center" :class="room.amenities['Pet-Friendly'] ? 'text-dark-gray' : 'text-light-gray'">
